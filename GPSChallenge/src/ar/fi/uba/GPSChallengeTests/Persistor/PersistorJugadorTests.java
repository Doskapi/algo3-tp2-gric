...
public class PersistorJugadorTests extends TestCase {
	...
	public void testDespersistorDeUnJugador(){
		...
		Jugador jugador = despersistidor.despersistirJugador(System.getProperty("user.dir") + System.getProperty("file.separator") + "Jugadores" + System.getProperty("file.separator") + "MartinTest" + System.getProperty("file.separator") + "MartinTest.xml");
		Jugador otroJugador = new Jugador();
		otroJugador.setNombre("MartinTest");
		otroJugador.setPuntaje(0);
		otroJugador.setPartidaGuardada(System.getProperty("user.dir") + System.getProperty("file.separator") + "Jugadores" + System.getProperty("file.separator") + "MartinTest" + System.getProperty("file.separator") + "MartinTest.xml");
